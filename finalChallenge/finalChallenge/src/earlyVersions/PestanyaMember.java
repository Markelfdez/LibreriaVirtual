...
public class PestanyaMember extends JPanel implements ActionListener{
...
setLayout(null);
		...
		lblFoto1AdminMember.setIcon(new ImageIcon(PestanyaMember.class.getResource("/img/Admin_member-removebg-preview.png")));
		lblFoto1AdminMember.setBounds(10, 212, 246, 262);
		contentPanel.add(lblFoto1AdminMember);
		
		JLabel lblFoto2AdminMember = new JLabel("");
		lblFoto2AdminMember.setIcon(new ImageIcon(PestanyaMember.class.getResource("/img/Admin_member2-removebg-preview.png")));
