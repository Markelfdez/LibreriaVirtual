...
public class WindowTabBook extends JPanel implements ActionListener{
	...
	public WindowTabBook() {
		...
		lblFoto1AdminBook.setIcon(new ImageIcon(WindowTabBook.class.getResource("/img/Admin_book-removebg-preview (1).png")));
		lblFoto1AdminBook.setBounds(657, 267, 274, 214);
		contentPanel.add(lblFoto1AdminBook);
		
		JLabel lblFoto2AdminBook = new JLabel("");
		lblFoto2AdminBook.setIcon(new ImageIcon(WindowTabBook.class.getResource("/img/Admin_book2-removebg-preview.png")));
