...
public class WindowTabAuthor extends JPanel implements ActionListener{
	...
	public WindowTabAuthor() {
		...
		lblFoto1AdminAuthor.setIcon(new ImageIcon(WindowTabAuthor.class.getResource("/img/Admin_author-removebg-preview.png")));
		lblFoto1AdminAuthor.setBounds(0, 227, 278, 268);
		contentPanel.add(lblFoto1AdminAuthor);
		
		JLabel lblFoto2AdminAuthor = new JLabel("");
		lblFoto2AdminAuthor.setIcon(new ImageIcon(WindowTabAuthor.class.getResource("/img/Admin_author2-removebg-preview.png")));
