...
import controller.GeneralControllerImplementation;
import controller.MemberControllerImplementation;
...
public class LogInFrame extends JFrame implements ActionListener{
	...
	private GeneralControllerImplementation aux = new GeneralControllerImplementation();
	private MemberControllerImplementation auxW = new MemberControllerImplementation();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(btnLogIn)) {
			String passwd= passwordField.toString();
			boolean adminLoged = aux.logInAdmin(fieldUsername.getText(), passwd);
			boolean memberLoged = auxW.logIn(fieldUsername.getText(), passwd);
			if (adminLoged) {
				AdminMenu admin = new AdminMenu(true);
				admin.setVisible(true);
			} else if(memberLoged){
				MemberMenu vMember = new MemberMenu(true);
				vMember.setVisible(true);
			}else
				JOptionPane.showMessageDialog(this, "The username doesn't exist.", "ERROR WINDOW", JOptionPane.ERROR_MESSAGE);
