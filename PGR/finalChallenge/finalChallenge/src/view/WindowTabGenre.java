...
public class WindowTabGenre extends JPanel implements ActionListener{
	...
	public WindowTabGenre() {
		...
		lblFoto1AdminGenre.setIcon(new ImageIcon(WindowTabGenre.class.getResource("/img/Admin_genre2-removebg-preview.png")));
		lblFoto1AdminGenre.setBounds(10, 246, 243, 274);
		contentPanel.add(lblFoto1AdminGenre);
		
		JLabel lblFotos2AdminGenre = new JLabel("");
		lblFotos2AdminGenre.setIcon(new ImageIcon(WindowTabGenre.class.getResource("/img/Admin_genre-removebg-preview.png")));
